...
# Executing find keywords function
...
for files in os.listdir(path_of_directory):
        if files.endswith('.csv'):
            ...
            # Find keywords for each CSV file, append to one of 4 management CSVs for further analysis
...
find_keywords2.find_info_stock('/Users/jaimejacob/Documents/urop/condense_lines_proj/find_keywords2/current/stocking.csv')

#stocking_headers = "'LAKE NAME',CONTENTS',DATE',FUZZY MATCH',NO,Stage,Num,Species,"Trout, trout","Perch, perch","Rock Bass, rock bass","Walleye, walleye","Smallmouth Bass, smallmouth bass","Pike, pike","Suckers, suckers","Largemouth Bass, largemouth bass","Bluegill, bluegill","Bass, bass","Green Sunfish, green sunfish","Bullheads, bullheads","Pumpkinseed Sunfish, pumpkinseed sunfish","Rainbows, rainbows","Brook trout, brook trout","Pike, pike.1","Panfish, panfish","Grayling, grayling","Trash, trash","Black Spotted Trout, black spotted trout","Montana grayling, montana grayling","Chubs, chubs","Browns, browns","Hybrid Sunfish, hybrid sunfish","Sea Lamprey, sea lamprey","Splake, splake","Salmonid, salmonid","Common Shiners, common shiners","Tiger Muskies, tiger muskies","Whitefish, whitefish","Ichthyomyzon, ichthyomyzon","Brown trout, brown trout","Menominees, menominees","Sturgeon, sturgeon""
...
find_keywords2.find_info('/Users/jaimejacob/Documents/urop/condense_lines_proj/find_keywords2/current/habitat.csv', habitat_header)
...
find_keywords2.find_info('/Users/jaimejacob/Documents/urop/condense_lines_proj/find_keywords2/current/regulation.csv', reg_header)
...
find_keywords2.find_info('/Users/jaimejacob/Documents/urop/condense_lines_proj/find_keywords2/current/eradication.csv', eradication_header)

find_keywords2.seperate_years('/Users/jaimejacob/Documents/urop/condense_lines_proj/find_keywords2/current/stocking.csv', '/Users/jaimejacob/Documents/urop/condense_lines_proj/find_keywords2/stocking_csvs/stocking_by_year.csv')
find_keywords2.filter_stocking('/Users/jaimejacob/Documents/urop/condense_lines_proj/find_keywords2/stocking_csvs/stocking_by_year.csv', '/Users/jaimejacob/Documents/urop/condense_lines_proj/find_keywords2/stocking_csvs/filtered_stocking.csv')

find_keywords2.format_years('/Users/jaimejacob/Documents/urop/condense_lines_proj/find_keywords2/stocking_csvs/filtered_stocking.csv', '/Users/jaimejacob/Documents/urop/condense_lines_proj/find_keywords2/formatted_years/formatted_years_stocking.csv')
